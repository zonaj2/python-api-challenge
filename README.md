...
Used the [OpenWeatherMap API](https://www.markdownguide.org/basic-syntax/) to retrieve weather data from the generated cities list. Exported the city data to a .csv file (city_data.csv)
